  ...
  <div class="flex flex-col items-center">
    <div class="my-16">
      <a
        ...
        href="https://twitter.com/kokkiiclub"
      >
        <span class="mx-4 capitalize font-serif text-2xl">stay tuned!</span>
...
l-17 27 438 -2 439 -3 377 -548z"
            />
            <path
              d="M2359 2558 l918 -1313 196 -3 c108 -1 197 1 197 5 0 5 -411 595 -913
1313 l-913 1305 -202 3 -201 2 918 -1312z"
    ...
    <p class="mt-24 text-neutral-500">
      Copyright © 2023 All Rights Reserved
      <br />
      <a href="https://github.com/k1zang">
        <span class="text-sm">Designed by K1</span>
      </a>
    </p>
  </div>
</template>
